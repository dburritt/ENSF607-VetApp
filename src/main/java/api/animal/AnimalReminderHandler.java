...
public class AnimalReminderHandler extends Handler{
	...
	private ResponseEntity<AnimalReminderResponse> doPost(InputStream is) {
       ...
       NewAnimalReminder newReminder = NewAnimalReminder.builder()
                .reminder(animalReminderRequest.getReminder())
                .dateEntered(animalReminderRequest.getDateEntered())
                .dateDue(animalReminderRequest.getDateDue())
                .build();
    ...
    private ResponseEntity<AnimalReminderListResponse> doGet() {

    	AnimalReminderListResponse reminderListResponse = new AnimalReminderListResponse(animalService.getAnimalReminders());
